...
import { MoreHorizontal, Trash, Unlock, Eye, ArrowUpDown } from "lucide-react"
...
export default function BlockedUsersList({ users, onUnblock, onDelete }: BlockedUsersListProps) {
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-50">
              ...
              <TableHead className="font-semibold cursor-pointer " onClick={() => requestSort('phone')}>Phone Number</TableHead>
