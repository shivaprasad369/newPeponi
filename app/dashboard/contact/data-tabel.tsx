...
export function DataTables<TData, TValue>({ columns,pagination,setSearchTerm,term, data,page,setPage, totalBlogs,totalPages ,onDelete, onDeleteEach, onView }: DataTableProps<TData, TValue>) {
  ...
  return (
    <div>
      ...
      <div className="w-[100%] mt-3 flex items-end justify-end">
